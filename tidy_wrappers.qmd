...
All of these databases are optimized for certain things. In the case of `polars` the parallel processing and lazy evaluation provide the speed advantage over `dplyr` but is that also a benefit for smaller datasets? Where is the crossover point?
